...
const SCENARIOS = {
  // Sorting Pipeline
  'sorting-mc-practice':     { challengeId: 'sorting',     responseType: 'mc', mode: 'practice',   user: { name: 'Sarah Cohen', initials: 'SC' } },
  'sorting-mc-assessment':   { challengeId: 'sorting',     responseType: 'mc', mode: 'assessment', user: { name: 'Sarah Cohen', initials: 'SC' } },
  ...
  'sql-mc-practice':         { challengeId: 'sql',         responseType: 'mc', mode: 'practice',   user: { name: 'Sarah Cohen', initials: 'SC' } },
  'sql-mc-assessment':       { challengeId: 'sql',         responseType: 'mc', mode: 'assessment', user: { name: 'Sarah Cohen', initials: 'SC' } },
