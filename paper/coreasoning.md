...
supplied to the judging evaluator) versus the model's own judgment, we re-graded the transcripts with
that scaffolding removed. The effect is sharply skill-specific. Framing discrimination is essentially
