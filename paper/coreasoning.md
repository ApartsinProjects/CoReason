...
effect of the *other* skills' competence) averages **−0.017**, so own-skill effects exceed cross-skill
effects by more than an order of magnitude (about 60 to 1). Each
...
and the first principal factor accounts for only 42% of the variance, far below the near-100% a single
"AI-use ability" account would predict.
